setwd('D://Documents and Settings/mcooper/Google Drive/JRS/Odonata_Africa/')
...
res <- occ_search(out$orderKey, continent='Africa', fields=fields,
                  limit=200000)

dat <- res$data

write.csv(dat, paste0(taxa, '_Africa.csv'), row.names=F)
